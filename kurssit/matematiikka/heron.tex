...
\bibitem{sinilause}[Sin] Wikipedia: \href{https://fi.wikipedia.org/wiki/Sinilause}{\emph{Sinilause}} https://fi.wikipedia.org/wiki/Sinilause
\bibitem{kosinilause}[Cos] Wikipedia: \href{https://fi.wikipedia.org/wiki/Kosinilause}{\emph{Kosinilause}} https://fi.wikipedia.org/wiki/Kosinilause
\bibitem{heron}[Her] Wikipedia: \href{https://fi.wikipedia.org/wiki/Heronin_kaava}{\emph{Heronin kaava}} https://fi.wikipedia.org/wiki/Heronin\_kaava
\end{thebibliography}
\end{document}
